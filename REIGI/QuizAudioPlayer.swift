...
final class QuizAudioPlayer {
    static let shared = QuizAudioPlayer()
    ...
    private func findURL() -> URL? {
        ...
        return Bundle.main.urls(forResourcesWithExtension: nil, subdirectory: nil)?
            .first(where: { $0.deletingPathExtension().lastPathComponent.lowercased() == "quiz" })
    }
